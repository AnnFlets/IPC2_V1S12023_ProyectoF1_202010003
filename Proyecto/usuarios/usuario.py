...
class Usuario:
    ...
    def imprimir_peliculas_fav(self):
        ...
        for pelicula in self.peliculas_fav:
            print(id_pelicula, "- TÍTULO:", pelicula.get_titulo(), "| DIRECTOR:", pelicula.get_director(), "| AÑO:", pelicula.get_anio())
    ...
    def eliminar_pelicula_favorita(self, id_pelicula):
        if id_pelicula > 0 and id_pelicula <= len(self.peliculas_fav):
            self.peliculas_fav.pop(id_pelicula - 1)

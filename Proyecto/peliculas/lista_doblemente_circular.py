...
class ListaPeliculas:
                ...
                for peliculas in lista_peliculas_categoria:
                    ...
                    for pelicula in lista_peliculas:
                        ...
                        if not self.verificar_duplicado(nombre_categoria, titulo, director, anio, fecha, hora):
                            pelicula_leida = Pelicula(nombre_categoria, titulo, director, anio, fecha, hora)
    ...
    def modificar_pelicula(self, id, pelicula):
        ...
        if self.cabeza != None:
            ...
            while True:
                if actual.get_id() == id:
                    if not self.verificar_duplicado(pelicula.get_categoria(), pelicula.get_titulo(), pelicula.get_director(),
